...
def main():
    ...
    os.makedirs(os.path.join(DATA_DIR, "IntermediateData", "ConstantVelocityPlusNNFullData"))

    np.savez(
        os.path.join(
            DATA_DIR, "IntermediateData", "ConstantVelocityPlusNNFullData", "train.npz"
        ),
        data=train_data,
        X=trainXnorm,
        Y=trainYnorm,
    ...
    np.savez(
        os.path.join(
            DATA_DIR, "IntermediateData", "ConstantVelocityPlusNNFullData", "test.npz"
        ),
        data=test_data,
        X=testXnorm,
    )
